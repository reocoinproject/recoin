Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/reo/files/Bitcoin/reo-0.7.0/

We recommend that everybody running prior versions of reod/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/reocoinproject/recoin/tarball/v0.7.0  # .tar.gz
  https://github.com/reocoinproject/recoin/zipball/v0.7.0  # .zip
...
Core reo handling and blockchain database
...
* Ensure a changed reo unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for reo-qt.exe
* (Windows only): add meta-data to reo-qt.exe (e.g. description)
...
* Bash programmable completion for reod(1)
