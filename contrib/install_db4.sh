...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the reo repository."
  exit 1
fi
...
# See https://github.com/reocoinproject/recoin/issues/16064
...
echo 'When compiling reod, run `./configure` in the following way:'
echo
