Bitcoin Core version 0.13.1 is now available from:
  ...
  <https://reo.org/bin/reo-core-0.13.1/>
...
- **Signature covers value:** A simple improvement in the way signatures are
  ...
  of reos they think they are spending, and by having full nodes refuse to
  accept those signatures unless the amount of reos being spent is exactly
...
- **Increased security for multisig:** Reo addresses (both P2PKH addresses
...
[Segwit FAQ]: https://reocore.org/en/2016/01/26/segwit-benefits/
[segwit wallet Developers guide]: https://reocore.org/en/segwit_wallet_dev/
[BIP141]: https://github.com/reo/bips/blob/master/bip-0141.mediawiki
[BIP143]: https://github.com/reo/bips/blob/master/bip-0143.mediawiki
[BIP144]: https://github.com/reo/bips/blob/master/bip-0144.mediawiki
[BIP145]: https://github.com/reo/bips/blob/master/bip-0145.mediawiki
[versionbits FAQ]: https://reocore.org/en/2016/06/08/version-bits-miners-faq/
...
[BIP147]: https://github.com/reo/bips/blob/master/bip-0147.mediawiki
...
- #8848 `7a34a46` Add NULLDUMMY verify flag in reoconsensus.h (jl2012)
...
- #8940 `5b4192b` Add x9 service bit support to dnsseed.bluematt.me, seed.reostats.com (TheBlueMatt, cdecker)
- #8944 `685e4c7` Remove bogus assert on number of oubound connections. (TheBlueMatt)
- #8949 `0dbc48a` Be more agressive in getting connections to peers with relevant services (gmaxwell)

### Build system
- #8293 `fa5b249` Allow building libreoconsensus without any univalue (luke-jr)
- #8492 `8b0bdd3` Allow building bench_reo by itself (luke-jr)
...
- #8829 `2a8bca4` Add reo-tx JSON tests (jnewbery)
- #8834 `1dd1783` blockstore: Switch to dumb dbm (MarcoFalke)
- #8835 `d87227d` nulldummy.py: Don't run unused code (MarcoFalke)
- #8836 `eb18cc1` reo-util-test.py should fail if the output file is empty (jnewbery)
...
- #8860 `0bee740` util: Move wait_reods() into stop_nodes() (MarcoFalke)
...
- #8683 `8a7d7ff` Fix incorrect file name reo.qrc  (reosSG)
...
- #8817 `bcf3806` update reo-tx to output witness data (jnewbery)
