...
const char * const BITCOIN_CONF_FILENAME = "reo.conf";
 ...
 * https://github.com/reocoinproject/recoin/pull/16097#issuecomment-514627823
 */
...
bool ArgsManager::ParseParameters(int argc, const char* const argv[], std::string& error)
{
    ...
    for (int i = 1; i < argc; i++) {
        ...
        if (key == "-") break; //reo-tx using stdin
        std::string val;
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Reo
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Reo
    // Mac: ~/Library/Application Support/Reo
    // Unix: ~/.reo
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Reo";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Reo";
#else
    // Unix
    return pathRet / ".reo";
#endif
