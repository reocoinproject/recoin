...
RISC-V known issue: gcc-7.3.0 and gcc-7.3.1 result in a broken `test_reo` executable (see https://github.com/reocoinproject/recoin/pull/13543),
...
options will be passed to reo's configure. In this case, `--disable-wallet`.
