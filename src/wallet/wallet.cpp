...
bool CWallet::AddToWallet(const CWalletTx& wtxIn, bool fFlushOnClose)
{
    ...
    if (!strCmd.empty())
    {
        ...
        // https://github.com/reocoinproject/recoin/pull/13339#issuecomment-537384875
        // A few ways it could be implemented in the future are described in:
        // https://github.com/reocoinproject/recoin/pull/13339#issuecomment-461288094
...
{
    // If wallet doesn't have a chain (e.g reo-wallet), lock can't be taken.
    ...
    while (block_height && !fAbortRescan && !chain().shutdownRequested()) {
        ...
        if (chain().findBlock(block_hash, &block) && !block.IsNull()) {
            ...
            if (!locked_chain->getBlockHeight(block_hash)) {
                ...
                // https://github.com/reocoinproject/recoin/pull/14711#issuecomment-458342518
                         ...
                         int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign)
{
    ...
    int nBytes;
    {
        ...
        LOCK(cs_wallet);
        {
            ...
            // change transaction isn't always pay-to-reo-address
...
DBErrors CWallet::LoadWallet(bool& fFirstRunRet)
{
    ...
    // tx status. If lock can't be taken (e.g reo-wallet), tx confirmation
 ...
 * https://reotalk.org/?topic=54527, or
 * https://github.com/reocoinproject/recoin/pull/1393.
 */
...
int CWalletTx::GetBlocksToMaturity() const
{
    ...
    //REOTODO Some wallets are still not abandoning coinstakes correctly
...
void CWallet::StakeREOs(bool fStake, CConnman* connman, CTxMemPool* mempool)
{
    ::StakeREOs(fStake, this, connman, mempool, stakeThread);
}

void CWallet::StartStake(CConnman *connman, CTxMemPool* mempool)
{
    m_enabled_staking = true;
    StakeREOs(true, connman, mempool);
}
