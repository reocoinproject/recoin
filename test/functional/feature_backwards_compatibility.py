...
class BackwardsCompatibilityTest(BitcoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        self.add_nodes(self.num_nodes, extra_args=self.extra_args, versions=[
            ...
            self.options.reod,
            self.options.reod,
            releases_path + "/v0.19.0.1/bin/reod",
            releases_path + "/v0.18.1/bin/reod",
            releases_path + "/v0.17.1/bin/reod"
        ], binary_cli=[
            self.options.reocli,
            self.options.reocli,
            releases_path + "/v0.19.0.1/bin/reo-cli",
            releases_path + "/v0.18.1/bin/reo-cli",
            releases_path + "/v0.17.1/bin/reo-cli"
        ])
    ...
    def run_test(self):
        ...
        # RPC loadwallet failure causes reod to exit, in addition to the RPC
