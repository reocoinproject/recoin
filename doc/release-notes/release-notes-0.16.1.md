Bitcoin Core version 0.16.1 is now available from:
  ...
  <https://reocore.org/bin/reo-core-0.16.1/>
...
- #12843 `df38b13` Test starting reod with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure reod processes are cleaned up when tests end (sdaftuar)
