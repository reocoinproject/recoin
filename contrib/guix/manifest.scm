...
(define* (make-reo-cross-toolchain target
                                  #:key
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-reo-cross-toolchain "i686-linux-gnu")
       (make-reo-cross-toolchain "x86_64-linux-gnu")
       (make-reo-cross-toolchain "aarch64-linux-gnu")
       (make-reo-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-reo-cross-toolchain "riscv64-linux-gnu"
