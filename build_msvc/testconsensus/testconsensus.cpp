...
// reo includes.
#include <..\src\script\reoconsensus.h>
...
int main()
{
    std::cout << "reoconsensus version: " << reoconsensus_version() << std::endl;
    ...
    auto op0Result = reoconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, reoconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
