...
/* A AEAD class for ChaCha20-Poly1305@reo.
 *
 ...
 *
 * The chacha20-poly1305@reo combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@reo cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@reo are relatively fast in
