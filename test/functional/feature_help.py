...
"""Verify that starting reo with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start reo with -h for help text")
        ...
        self.log.info("Start reo with -version for version information")
        ...
        self.log.info("Start reod with -fakearg to make sure it does not start")
