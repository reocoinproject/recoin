    ...
    mapper(nullptr)
{
    ...
    ui->reoAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->reoAtStartup);
    ...
    ui->reoAtStartup->setToolTip(ui->reoAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->reoAtStartup->setText(ui->reoAtStartup->text().arg(PACKAGE_NAME));
...
{
    /* Main */
    mapper->addMapping(ui->reoAtStartup, OptionsModel::StartAtStartup);
