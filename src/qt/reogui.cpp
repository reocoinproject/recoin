...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Reo address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Reo : URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Reo addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Reo addresses"));
    ...
    openAction->setStatusTip(tr("Open a reo: URI"));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Reo network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
