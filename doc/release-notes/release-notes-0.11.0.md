Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://reo.org/bin/reo-core-0.11.0/>
...
For example, add the following to `reo.conf`:
...
related to the blockchain in the reo system: the raw blocks as received over 
...
For an example script see [reo-submittx](https://github.com/laanwj/reo-submittx).
...
- #5334 `cf87536` libreoconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new reo-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add reo logo to about screen
...
- #5809 `46bfbe7` Add reo-cli man page
...
- #5849 `41259ca` contrib/init/reod.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for reo-tx)
